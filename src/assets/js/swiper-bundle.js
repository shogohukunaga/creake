var Swiper = (() => {
  ...
  function w(e) {
    ...
    for (let e = 1; e < arguments.length; e += 1) {
      ...
      if (
        ...
        let a = Object.keys(Object(i)).filter((e) => t.indexOf(e) < 0);
          ...
          void 0 !== l &&
            ...
            (d(s[r]) && d(i[r])
              ? i[r].__swiper__
                ? (s[r] = i[r])
                : w(s[r], i[r])
              : d(s[r]) || !d(i[r]) || ((s[r] = {}), i[r].__swiper__)
                ? (s[r] = i[r])
                : w(s[r], i[r]));
        }
      }
  ...
  function D(e) {
    ...
    return { top: s.top + r - i, left: s.left + t - a };
  }
  function C(e, t) {
  ...
  let F = {
      on(e, a, s) {
        let i = this;
        if (i.eventsListeners && !i.destroyed && "function" == typeof a) {
          let t = s ? "unshift" : "push";
          e.split(" ").forEach((e) => {
            (i.eventsListeners[e] || (i.eventsListeners[e] = []),
              i.eventsListeners[e][t](a));
          });
        }
        return i;
      },
    ...
    l = (a, e) => {
      if (a && !a.destroyed && a.params) {
        let t = e.closest(
          a.isElement ? "swiper-slide" : "." + a.params.slideClass,
        );
        if (t) {
    ...
    u = (n) => {
      if (n && !n.destroyed && n.params) {
        let l = n.params.lazyPreloadPrevNext,
          s = n.slides.length;
        if (s && l && !(l < 0)) {
          l = Math.min(l, s);
          let i =
          ...
          if (n.params.grid && 1 < n.params.grid.rows) {
            let a = r,
              s = [a - l];
            (s.push(...Array.from({ length: l }).map((e, t) => a + i + t)),
              void n.slides.forEach((e, t) => {
                s.includes(e.column) && o(n, t);
              }));
          } else {
            let a = r + i - 1;
            if (n.params.rewind || n.params.loop)
              for (let t = r - l; t <= a + l; t += 1) {
                let e = ((t % s) + s) % s;
                (e < r || e > a) && o(n, e);
              }
            else
              for (
                let e = Math.max(r - l, 0);
                e <= Math.min(a + l, s - 1);
                e += 1
              )
                e !== r && (e > a || e < r) && o(n, e);
    ...
    W = {
      updateSize: function () {
        ...
        ((t = null != e.params.width ? e.params.width : s.clientWidth),
          (a = null != e.params.height ? e.params.height : s.clientHeight),
          (0 === t && e.isHorizontal()) ||
            (0 === a && e.isVertical()) ||
            ((t =
              t -
      ...
      updateSlides: function () {
        ...
        let r = i.params,
          ...
          n = i.virtual && r.virtual.enabled,
          p = (n ? i.virtual : i).slides.length,
          c = O(t, `.${i.params.slideClass}, swiper-slide`),
          u = (n ? i.virtual.slides : c).length,
          m = [],
          h = [],
          f = [],
          v = r.slidesOffsetBefore,
          g =
            ("function" == typeof v && (v = r.slidesOffsetBefore.call(i)),
            r.slidesOffsetAfter);
        ...
        if (void 0 !== l) {
          ("string" == typeof y && 0 <= y.indexOf("%")
            ...
            r.centeredSlides &&
              r.cssMode &&
              (L(e, "--swiper-centered-offset-before", ""),
              L(e, "--swiper-centered-offset-after", "")));
          ...
          for (let s = 0; s < u; s += 1) {
            ...
            if (
              ((o = 0),
              c[s] && (n = c[s]),
              T && i.grid.updateSlide(s, n, c),
              !c[s] || "none" !== C(n, "display"))
            ) {
              if ("auto" === r.slidesPerView) {
                M && (c[s].style[i.getDirectionLabel("width")] = "");
                let t = getComputedStyle(n),
                  e = n.style.transform,
                  a = n.style.webkitTransform;
                if (
                  (e && (n.style.transform = "none"),
                  a && (n.style.webkitTransform = "none"),
                  r.roundLengths)
                )
                  o = i.isHorizontal() ? B(n, "width", !0) : B(n, "height", !0);
                else {
                  let a = d(t, "width"),
                    s = d(t, "padding-left"),
                    i = d(t, "padding-right"),
                  ...
                  if (e && "border-box" === e) o = a + r + l;
                    ...
                    let { clientWidth: e, offsetWidth: t } = n;
                    o = a + s + i + r + l + (t - e);
                  }
                }
                (e && (n.style.transform = e),
                  a && (n.style.webkitTransform = a),
                  r.roundLengths && (o = Math.floor(o)));
              } else
                ((o = (l - (r.slidesPerView - 1) * y) / r.slidesPerView),
                  r.roundLengths && (o = Math.floor(o)),
                  c[s] &&
                    (c[s].style[i.getDirectionLabel("width")] = o + "px"));
          ...
          if (
            ((i.virtualSize = Math.max(i.virtualSize, l) + g),
            a &&
              s &&
            ...
            r.setWrapperSize &&
              (e.style[i.getDirectionLabel("width")] =
                i.virtualSize + y + "px"),
            T && i.grid.updateWrapperSize(o, m),
            !r.centeredSlides)
          ) {
            let a = [];
          ...
          if (n && r.loop) {
            ...
            if (1 < r.slidesPerGroup) {
              let t = Math.ceil(
                ...
                a = s * r.slidesPerGroup;
              for (let e = 0; e < t; e += 1) m.push(m[m.length - 1] + a);
            }
            for (
              let e = 0;
              ...
              (1 === r.slidesPerGroup && m.push(m[m.length - 1] + s),
          ...
          if (
            ...
            (L(e, "--swiper-centered-offset-before", -m[0] + "px"),
              L(
                e,
          ...
          if (
            ...
            !(n || r.cssMode || ("slide" !== r.effect && "fade" !== r.effect)))
          ) {
            let e = r.containerModifierClass + "backface-hidden",
              t = i.el.classList.contains(e);
            u <= r.maxBackfaceHiddenSlides
              ? t || i.el.classList.add(e)
              : t && i.el.classList.remove(e);
          }
        }
      },
      ...
      updateSlidesProgress: function (e) {
        ...
        var i = this,
          r = i.params,
          { slides: l, rtlTranslate: n, snapGrid: o } = i;
        if (0 !== l.length) {
          ...
          "string" == typeof s && 0 <= s.indexOf("%")
            ? (s = (parseFloat(s.replace("%", "")) / 100) * i.size)
          ...
          for (let t = 0; t < l.length; t += 1) {
            ...
            var p =
                (a + (r.centeredSlides ? i.minTranslate() : 0) - e) /
                (d.swiperSlideSize + s),
              c =
                (a - o[0] + (r.centeredSlides ? i.minTranslate() : 0) - e) /
                (d.swiperSlideSize + s),
              u = -(a - e),
              m = u + i.slidesSizesGrid[t],
              h = 0 <= u && u <= i.size - i.slidesSizesGrid[t],
              u =
                (0 <= u && u < i.size - 1) ||
                (1 < m && m <= i.size) ||
                (u <= 0 && m >= i.size);
            (u && (i.visibleSlides.push(d), i.visibleSlidesIndexes.push(t)),
              _(d, u, r.slideVisibleClass),
              _(d, h, r.slideFullyVisibleClass),
              (d.progress = n ? -p : p),
              (d.originalProgress = n ? -c : c));
          }
        }
      },
      updateProgress: function (l) {
        var n = this;
        if (void 0 === l) {
          let e = n.rtlTranslate ? -1 : 1;
          l = (n && n.translate && n.translate * e) || 0;
        }
        let e = n.params,
          a = n.maxTranslate() - n.minTranslate(),
          { progress: s, isBeginning: i, isEnd: r, progressLoop: o } = n,
          t = i,
          d = r;
        if (0 === a) ((s = 0), (i = !0), (r = !0));
        else {
          s = (l - n.minTranslate()) / a;
          let e = Math.abs(l - n.minTranslate()) < 1,
            t = Math.abs(l - n.maxTranslate()) < 1;
          ((i = e || s <= 0), (r = t || 1 <= s), e && (s = 0), t && (s = 1));
        }
        if (e.loop) {
          let e = n.getSlideIndexByData(0),
            t = n.getSlideIndexByData(n.slides.length - 1),
            a = n.slidesGrid[e],
            s = n.slidesGrid[t],
            i = n.slidesGrid[n.slidesGrid.length - 1],
            r = Math.abs(l);
          1 < (o = r >= a ? (r - a) / i : (r + i - s) / i) && --o;
        }
        (Object.assign(n, {
          progress: s,
          progressLoop: o,
          ...
          (e.watchSlidesProgress || (e.centeredSlides && e.autoHeight)) &&
            n.updateSlidesProgress(l),
          i && !t && n.emit("reachBeginning toEdge"),
          r && !d && n.emit("reachEnd toEdge"),
          ((t && !i) || (d && !r)) && n.emit("fromEdge"),
          n.emit("progress", s));
      },
      updateSlidesClasses: function () {
        let t = this,
          { slides: e, params: a, slidesEl: s, activeIndex: i } = t,
          r = t.virtual && a.virtual.enabled,
          l = t.grid && a.grid && 1 < a.grid.rows,
          n = (e) => O(s, `.${a.slideClass}${e}, swiper-slide` + e)[0],
          o,
          d,
          p;
        if (r)
            ...
            (d = ((e) => {
              ...
              for (let e = 0; e < t.length; e += 1)
                void 0 !== t[e + 1]
                  ...
                  : s >= t[e] && (i = e);
              return (i =
                a.normalizeSlideIndex && (i < 0 || void 0 === i) ? 0 : i);
            })(s)),
          0 <= a.indexOf(t))
        )
          o = a.indexOf(t);
        else {
          let e = Math.min(i.slidesPerGroupSkip, d);
          o = e + Math.floor((d - e) / i.slidesPerGroup);
        }
        if ((o >= a.length && (o = a.length - 1), d !== r || s.params.loop))
          if (d === r && s.params.loop && s.virtual && s.params.virtual.enabled)
            s.realIndex = e(d);
          else {
            var p = s.grid && i.grid && 1 < i.grid.rows;
            let a;
            ...
            (Object.assign(s, {
              ...
              (s.initialized || s.params.runCallbacksOnInit) &&
                (l !== a && s.emit("realIndexChange"), s.emit("slideChange")));
          }
    ...
    j = {
      ...
      setTranslate: function (e, t) {
        var a = this,
          { rtlTranslate: s, params: i, wrapperEl: r, progress: l } = a;
        let n = 0,
          o = 0;
        ...
        ((0 == s ? 0 : (e - a.minTranslate()) / s) !== l && a.updateProgress(e),
        ...
        if ((r.updateProgress(o), l.cssMode)) {
          ...
          if (0 === t) n[e ? "scrollLeft" : "scrollTop"] = -o;
            ...
            if (!r.support.smoothScroll)
              return (
                b({ swiper: r, targetPosition: -o, side: e ? "left" : "top" }),
                !0
              );
  ...
  function Z() {
    ...
    (a && 0 === a.offsetWidth) ||
      ...
      ({ allowSlideNext: s, allowSlidePrev: i, snapGrid: r } = e),
  ...
  let Q = (e, t) => {
      ...
      i &&
        ...
        s.updateOnWindowResize
          ...
          : e[t]("observerUpdate", Z, !0),
        i[o]("load", e.onLoad, { capture: !0 }));
    },
    J = (e, t) => e.grid && t.grid && 1 < t.grid.rows;
  var ee = {
    init: !0,
  ...
  let a = {
      ...
      slide: {
        slideTo: function (e, a, t, s, i) {
          ...
          let g;
          (l !== (p || 0) && t && r.emit("beforeSlideChangeStart"),
            r.updateProgress(v),
            (g = l > c ? "next" : l < c ? "prev" : "reset"));
          ...
          if (
            ...
            return (
              ...
              "slide" !== n.effect && r.setTranslate(v),
              "reset" != g && (r.transitionStart(t, g), r.transitionEnd(t, g)),
              !1
            );
          if (n.cssMode) {
            let e = r.isHorizontal(),
            ...
            if (0 === a)
              (w &&
                ...
                w && !r._cssModeVirtualInitialSet && 0 < r.params.initialSlide
              ...
              if (!r.support.smoothScroll)
                return (
                  b({ swiper: r, targetPosition: t, side: e ? "left" : "top" }),
                  !0
                );
            ...
            (r.setTransition(a),
              ...
              r.updateActiveIndex(l),
              r.updateSlidesClasses(),
              r.emit("beforeTransitionStart", a, s),
              r.transitionStart(t, g),
              0 === a
                ? r.transitionEnd(t, g)
                : r.animating ||
                  ((r.animating = !0),
        ...
        slideToLoop: function (e, t, a, l) {
          ...
          if (!n.destroyed) {
            ...
            var o = n.grid && n.params.grid && 1 < n.params.grid.rows;
            let r = e;
            if (n.params.loop)
              if (n.virtual && n.params.virtual.enabled)
                ...
                } else a = n.getSlideIndexByData(r);
                let t = o
                    ? Math.ceil(n.slides.length / n.params.grid.rows)
                    : n.slides.length,
                  s = n.params.centeredSlides,
                  e = n.params.slidesPerView,
                  i =
                    ("auto" === e
                      ? (e = n.slidesPerViewDynamic())
                      : ((e = Math.ceil(
                          parseFloat(n.params.slidesPerView, 10),
                        )),
                        s && e % 2 == 0 && (e += 1)),
                    t - a < e);
                if (
                  (s && (i = i || a < Math.ceil(e / 2)),
                  (i =
                    l && s && "auto" !== n.params.slidesPerView && !o ? !1 : i))
                ) {
                  let e = s
                    ? a < n.activeIndex
                      ? "prev"
                  ...
                  n.loopFix({
                    direction: e,
                    slideTo: !0,
                    activeSlideIndex: "next" == e ? a + 1 : a - t + 1,
                    slideRealIndex: "next" == e ? n.realIndex : void 0,
                  });
                }
                if (o) {
                  let t = r * n.params.grid.rows;
        ...
        slideNext: function (e, t, a) {
          ...
          let n = r.slidesPerGroup,
            o =
              ...
              s.activeIndex < r.slidesPerGroupSkip ? 1 : n),
        ...
        slidePrev: function (t, a, s) {
          ...
          if (e.loop) {
            if (d && !p && e.loopPreventsSliding) return !1;
          ...
          if (void 0 === h && e.cssMode) {
            ...
            (r.forEach((e, t) => {
              ...
              void 0 !== a && (h = r[0 < a ? a - 1 : a]));
          }
          let f = 0;
          if (
            (void 0 !== h &&
              ((f = l.indexOf(h)) < 0 && (f = i.activeIndex - 1),
              "auto" === e.slidesPerView) &&
              1 === e.slidesPerGroup &&
              e.slidesPerGroupAuto &&
              ((f = f - i.slidesPerViewDynamic("previous", !0) + 1),
              (f = Math.max(f, 0))),
            e.rewind && i.isBeginning)
          ) {
            let e =
              i.params.virtual && i.params.virtual.enabled && i.virtual
                ? i.virtual.slides.length - 1
                : i.slides.length - 1;
            return i.slideTo(e, t, a, s);
          }
          return e.loop && 0 === i.activeIndex && e.cssMode
            ? (requestAnimationFrame(() => {
                i.slideTo(f, t, a, s);
              }),
              !0)
        ...
        slideToClosest: function (e, a, s, i) {
          (void 0 === a && (a = !0), void 0 === i && (i = 0.5));
          var r = this;
          if (!r.destroyed) {
            void 0 === e && (e = r.params.speed);
            let t = r.activeIndex;
            var l = Math.min(r.params.slidesPerGroupSkip, t),
              l = l + Math.floor((t - l) / r.params.slidesPerGroup),
              n = r.rtlTranslate ? r.translate : -r.translate;
            if (n >= r.snapGrid[l]) {
              let e = r.snapGrid[l];
              n - e > (r.snapGrid[l + 1] - e) * i &&
                (t += r.params.slidesPerGroup);
            } else {
              let e = r.snapGrid[l - 1];
              n - e <= (r.snapGrid[l] - e) * i &&
                (t -= r.params.slidesPerGroup);
            }
            return (
              (t = Math.max(t, 0)),
        ...
        slideToClickedSlide: function () {
          ...
          if (!a.destroyed) {
            ...
            s.loop
              ? a.animating ||
                ((e = parseInt(
                  a.clickedSlide.getAttribute("data-swiper-slide-index"),
                  10,
                )),
                s.centeredSlides
                  ? t < a.loopedSlides - r / 2 ||
                    t > a.slides.length - a.loopedSlides + r / 2
                    ? (a.loopFix(),
                      (t = a.getSlideIndex(
                        O(i, l + `[data-swiper-slide-index="${e}"]`)[0],
                      )),
                      M(() => {
                        a.slideTo(t);
                      }))
      ...
      loop: {
        loopCreate: function (e) {
          let a = this,
            { params: s, slidesEl: t } = a;
          var i, r, l, n, o;
          !s.loop ||
            (a.virtual && a.params.virtual.enabled) ||
            ((i = () => {
              O(t, `.${s.slideClass}, swiper-slide`).forEach((e, t) => {
                e.setAttribute("data-swiper-slide-index", t);
              });
            }),
            (n = a.grid && s.grid && 1 < s.grid.rows),
            (r = s.slidesPerGroup * (n ? s.grid.rows : 1)),
            (l = a.slides.length % r != 0),
            (n = n && a.slides.length % s.grid.rows != 0),
            (o = (t) => {
              for (let e = 0; e < t; e += 1) {
                let e = a.isElement
                  ? z("swiper-slide", [s.slideBlankClass])
                  : z("div", [s.slideClass, s.slideBlankClass]);
                a.slidesEl.append(e);
              }
            }),
            l
              ? s.loopAddBlankSlides
                ? (o(r - (a.slides.length % r)),
                  a.recalcSlides(),
                  a.updateSlides())
                : P(
        ...
        loopFix: function (m) {
          ...
          if (E.params.loop) {
            ...
            if (
              ((E.allowSlidePrev = !0),
              (E.allowSlideNext = !0),
              E.virtual && c.virtual.enabled)
            )
              (f &&
                (c.centeredSlides || 0 !== E.snapIndex
                  ? c.centeredSlides && E.snapIndex < c.slidesPerView
                    ? E.slideTo(
                        E.virtual.slides.length + E.snapIndex,
                        0,
                        !1,
                        !0,
                      )
                    : E.snapIndex === E.snapGrid.length - 1 &&
                      E.slideTo(E.virtual.slidesBefore, 0, !1, !0)
                  : E.slideTo(E.virtual.slides.length, 0, !1, !0)),
                (E.allowSlidePrev = t),
                (E.allowSlideNext = d));
            else {
              let e = c.slidesPerView;
              "auto" === e
                ? (e = E.slidesPerViewDynamic())
                : ((e = Math.ceil(parseFloat(c.slidesPerView, 10))),
                  u && e % 2 == 0 && (e += 1));
              m = c.slidesPerGroupAuto ? e : c.slidesPerGroup;
              let a = m;
              (a % m != 0 && (a += m - (a % m)),
                (a += c.loopAdditionalSlides),
                (E.loopedSlides = a));
              ...
              void 0 === w
                ? (w = E.getSlideIndex(
                    o.filter((e) =>
                      e.classList.contains(c.slideActiveClass),
                    )[0],
                  ))
                : (r = w);
              var S = "next" === v || !v,
              ...
              let l = 0,
                n = 0;
              var M = x ? Math.ceil(o.length / c.grid.rows) : o.length,
                C =
                  (x ? o[w].column : w) +
                  (u && void 0 === g ? -e / 2 + 0.5 : 0);
              if (C < a) {
                l = Math.max(a - C, m);
                for (let t = 0; t < a - C; t += 1) {
                  let e = t - Math.floor(t / M) * M;
                  if (x) {
                    let t = M - e - 1;
                    for (let e = o.length - 1; 0 <= e; --e)
                      o[e].column === t && s.push(e);
                  } else s.push(M - e - 1);
                }
              } else if (C + e > M - a) {
                n = Math.max(C - (M - 2 * a), m);
                for (let e = 0; e < n; e += 1) {
              ...
              if (
                ...
                T &&
                  s.forEach((e) => {
                    ((o[e].swiperLoopMoveDOM = !0),
                      p.prepend(o[e]),
                      (o[e].swiperLoopMoveDOM = !1));
                  }),
                S &&
                  i.forEach((e) => {
                    ((o[e].swiperLoopMoveDOM = !0),
                ...
                "auto" === c.slidesPerView
                  ? E.updateSlides()
                  : x &&
                    ((0 < s.length && T) || (0 < i.length && S)) &&
                    E.slides.forEach((e, t) => {
                      E.grid.updateSlide(t, e, E.slides);
                    }),
                c.watchSlidesProgress && E.updateSlidesOffset(),
                f)
              )
                if (0 < s.length && T) {
                  if (void 0 === h) {
                    let e = E.slidesGrid[r],
                      t = E.slidesGrid[r + l] - e;
                    y
                      ? E.setTranslate(E.translate - t)
                      : (E.slideTo(r + Math.ceil(l), 0, !1, !0),
                        g &&
                          ((E.touchEventsData.startTranslate =
                            E.touchEventsData.startTranslate - t),
                          (E.touchEventsData.currentTranslate =
                            E.touchEventsData.currentTranslate - t)));
                  } else if (g) {
                    let e = x ? s.length / c.grid.rows : s.length;
                    (E.slideTo(E.activeIndex + e, 0, !1, !0),
                      (E.touchEventsData.currentTranslate = E.translate));
                  }
                } else if (0 < i.length && S)
                  if (void 0 === h) {
                    let e = E.slidesGrid[r],
                      t = E.slidesGrid[r - n] - e;
                    y
                      ? E.setTranslate(E.translate - t)
                      : (E.slideTo(r - n, 0, !1, !0),
                        g &&
                    ...
                    let e = x ? i.length / c.grid.rows : i.length;
                    E.slideTo(E.activeIndex - e, 0, !1, !0);
                  }
              if (
                ((E.allowSlidePrev = t),
                (E.allowSlideNext = d),
                E.controller && E.controller.control && !b)
              ) {
                let t = {
                  slideRealIndex: h,
                  direction: v,
                ...
                Array.isArray(E.controller.control)
                  ? E.controller.control.forEach((e) => {
                      !e.destroyed &&
                        e.params.loop &&
                        e.loopFix({
                          ...t,
                          slideTo:
                            e.params.slidesPerView === c.slidesPerView && f,
                        });
                    })
                  : E.controller.control instanceof E.constructor &&
                    E.controller.control.params.loop &&
                    E.controller.control.loopFix({
                      ...t,
                      slideTo:
                        E.controller.control.params.slidesPerView ===
                          c.slidesPerView && f,
                    });
              }
            }
      ...
      events: {
        attachEvents: function () {
          ...
          ((e.onTouchStart = function (a) {
            ...
            if ("touchstart" === r.type) K(s, r, r.targetTouches[0].pageX);
            else {
              var { params: l, touches: n, enabled: o } = s;
              if (
                o &&
                ...
                if (
                  ...
                  ((o = t),
                  (e = s.wrapperEl),
                  !(d = e.contains(o)) && e instanceof HTMLSlotElement
                    ? [...e.assignedElements()].includes(o)
                    : d)
                )
                  if (
                    !(
                    ...
                    var e = !!l.noSwipingClass && "" !== l.noSwipingClass,
                      ...
                      o = !(!r.target || !r.target.shadowRoot);
                    if (
                      l.noSwiping &&
                      (o
                        ? (function (s, e) {
                      ...
                      if (K(s, r, o)) {
                        ...
                        o = e && s.allowTouchMove && l.touchStartPreventDefault;
                        ((!l.touchStartForcePreventDefault && !o) ||
                          t.isContentEditable ||
                          r.preventDefault(),
                          l.freeMode &&
                            l.freeMode.enabled &&
            ...
            (e.onTouchMove = function (t) {
              let a = I(),
                i = this,
                r = i.touchEventsData,
                { params: l, touches: n, rtlTranslate: o, enabled: e } = i;
              if (e && (l.simulateTouch || "mouse" !== t.pointerType)) {
                let e,
                  s = t;
                if (
                  "pointermove" ===
                  ...
                  if (s.preventedByNestedSwiper)
                    ...
                    if (l.touchReleaseOnEdges && !l.loop)
                      if (i.isVertical()) {
                        ...
                        (t < n.startX && i.translate <= i.maxTranslate()) ||
                        (t > n.startX && i.translate >= i.minTranslate())
                      )
                        return;
                    if (
                      (a.activeElement &&
                        a.activeElement.matches(r.focusableElements) &&
                        a.activeElement !== s.target &&
                        "mouse" !== s.pointerType &&
                      ...
                      if (
                        !(
                          i.params.threshold &&
                          Math.sqrt(p ** 2 + c ** 2) < i.params.threshold
                        )
                      )
                        if (
                          ...
                          ((i.allowClick = !1),
                            !l.cssMode && s.cancelable && s.preventDefault(),
                            l.touchMoveStopPropagation &&
                              !l.nested &&
                              s.stopPropagation());
                          let a = i.isHorizontal() ? p : c,
                            e = i.isHorizontal()
                          ...
                          (l.oneWayMovement &&
                            ...
                            (a *= l.touchRatio),
                            o && ((a = -a), (e = -e)));
                          var u = i.touchesDirection,
                            p =
                              ((i.swipeDirection = 0 < a ? "prev" : "next"),
                              (i.touchesDirection = 0 < e ? "prev" : "next"),
                              i.params.loop && !l.cssMode),
                            c =
                              ("next" === i.touchesDirection &&
                                i.allowSlideNext) ||
                              ("prev" === i.touchesDirection &&
                                i.allowSlidePrev);
                          if (!r.isMoved) {
                            if (
                              (p &&
                          ...
                          if (
                            ...
                            (i.emit("sliderMove", s),
                              (r.isMoved = !0),
                              (r.currentTranslate = a + r.startTranslate));
                            let e = !0,
                              t = l.resistanceRatio;
                            if (
                              (l.touchReleaseOnEdges && (t = 0),
                              0 < a
                                ? (p &&
                                    c &&
                                    r.allowThresholdMove &&
                                    r.currentTranslate >
                                      (l.centeredSlides
                                        ? i.minTranslate() -
                                          ...
                                          2 <= i.slides.length - l.slidesPerView
                                            ? i.slidesSizesGrid[
                                                i.activeIndex + 1
                                ...
                                : a < 0 &&
                                  ...
                                  (r.currentTranslate =
                                    i.maxTranslate() +
                                    1 -
                                    (i.maxTranslate() - r.startTranslate - a) **
                                      t),
            ...
            (e.onTouchEnd = function (i) {
              ...
              if (
                "touchend" ===
                  (l = l.originalEvent ? l.originalEvent : l).type ||
                "touchcancel" === l.type
              ) {
                if (
                  !(e = [...l.changedTouches].filter(
              ...
              if (
                ...
                if (d && (n.simulateTouch || "mouse" !== l.pointerType))
                  if (
                    (t.allowTouchCallbacks && r.emit("touchEnd", l),
                    ...
                    if (r.allowClick) {
                      ...
                      (r.updateClickedSlide((e && e[0]) || l.target, e),
                        r.emit("tap click", l),
                        c < 300 &&
                          d - t.lastClickTime < 300 &&
                          r.emit("doubleTap doubleClick", l));
                    }
                    if (
                      ((t.lastClickTime = g()),
                      M(() => {
                      ...
                      if (
                        ...
                        if (n.freeMode && n.freeMode.enabled)
                          r.freeMode.onTouchEnd({ currentPos: p });
                        else {
                          var u = p >= -r.maxTranslate() && !r.params.loop;
                          let a = 0,
                          ...
                          c > n.longSwipesMs
                            ? n.longSwipes
                              ? ("next" === r.swipeDirection &&
                                  (d >= n.longSwipesRatio
                                    ? r.slideTo(n.rewind && r.isEnd ? e : a + i)
                                    : r.slideTo(a)),
                                "prev" === r.swipeDirection &&
                                  (d > 1 - n.longSwipesRatio
                                    ...
                                    : null !== t &&
                                        d < 0 &&
                                        Math.abs(d) > n.longSwipesRatio
                                      ? r.slideTo(t)
                                      : r.slideTo(a)))
                              : r.slideTo(r.activeIndex)
                            : n.shortSwipes
                              ? !r.navigation ||
                                (l.target !== r.navigation.nextEl &&
                                  l.target !== r.navigation.prevEl)
                                ? ("next" === r.swipeDirection &&
                                    r.slideTo(null !== e ? e : a + i),
                                  "prev" === r.swipeDirection &&
                                    r.slideTo(null !== t ? t : a))
                                : l.target === r.navigation.nextEl
                                  ? r.slideTo(a + i)
                                  : r.slideTo(a)
                              : r.slideTo(r.activeIndex);
                    ...
                    (t.isMoved && n.grabCursor && r.setGrabCursor(!1),
                      (t.isMoved = !1),
                      (t.startMoving = !1));
              }
            }.bind(e)),
      ...
      breakpoints: {
        setBreakpoint: function () {
          let l = this,
            { realIndex: n, initialized: o, params: d, el: p } = l,
            c = d.breakpoints;
          if (c && 0 !== Object.keys(c).length) {
            var u = l.getBreakpoint(c, l.params.breakpointsBase, l.el);
            if (u && l.currentBreakpoint !== u) {
              let s = (u in c ? c[u] : void 0) || l.originalParams,
                e = J(l, d),
                t = J(l, s),
                a = l.params.grabCursor,
                i = s.grabCursor,
                r = d.enabled;
              (e && !t
                ? (p.classList.remove(
                ...
                : !e &&
                  t &&
                  (p.classList.add(d.containerModifierClass + "grid"),
                  ((s.grid.fill && "column" === s.grid.fill) ||
                    (!s.grid.fill && "column" === d.grid.fill)) &&
                    p.classList.add(d.containerModifierClass + "grid-column"),
                  l.emitContainerClasses()),
                a && !i ? l.unsetGrabCursor() : !a && i && l.setGrabCursor(),
              ...
              var m = s.direction && s.direction !== d.direction,
                h = d.loop && (s.slidesPerView !== d.slidesPerView || m),
                f = d.loop,
                m =
                  (m && o && l.changeDirection(),
                  w(l.params, s),
                  l.params.enabled),
                v = l.params.loop;
              (Object.assign(l, {
                ...
                r && !m ? l.disable() : !r && m && l.enable(),
                (l.currentBreakpoint = u),
                l.emit("_beforeBreakpoint", s),
                o &&
                  (h
                    ? (l.loopDestroy(), l.loopCreate(n), l.updateSlides())
                    : !f && v
                      ? (l.loopCreate(n), l.updateSlides())
                      : f && !v && l.loopDestroy()),
                l.emit("breakpoint", s));
            }
          }
        },
        getBreakpoint: function (e, l, n) {
          if ((void 0 === l && (l = "window"), e && ("container" !== l || n))) {
            let s = !1,
              i = A(),
              a = "window" === l ? i.innerHeight : n.clientHeight,
            ...
            for (let a = 0; a < r.length; a += 1) {
              let { point: e, value: t } = r[a];
              "window" === l
                ? i.matchMedia(`(min-width: ${t}px)`).matches && (s = e)
                : t <= n.clientWidth && (s = e);
            }
            return s || "max";
          }
      ...
      checkOverflow: {
        checkOverflow: function () {
          let a = this,
            { isLocked: e, params: t } = a,
            s = t.slidesOffsetBefore;
          if (s) {
            let e = a.slides.length - 1,
              t = a.slidesGrid[e] + a.slidesSizesGrid[e] + 2 * s;
            a.isLocked = a.size > t;
          } else a.isLocked = 1 === a.snapGrid.length;
          (!0 === t.allowSlideNext && (a.allowSlideNext = !a.isLocked),
            !0 === t.allowSlidePrev && (a.allowSlidePrev = !a.isLocked),
      ...
      classes: {
        addClasses: function () {
          var { classNames: e, params: t, rtl: a, el: s, device: i } = this,
            a = ((e, a) => {
              let s = [];
              return (
                e.forEach((t) => {
  ...
  class m {
    constructor() {
      ...
      let l = this,
        n =
          ((l.__swiper__ = !0),
          (l.support = R()),
          (l.device = q({ userAgent: a.userAgent })),
          (l.browser = V()),
          (l.eventsListeners = {}),
    ...
    getSlideIndex(e) {
      var { slidesEl: t, params: a } = this,
        t = G(O(t, `.${a.slideClass}, swiper-slide`)[0]);
      return G(e) - t;
    }
    ...
    slidesPerViewDynamic(e, t) {
      ...
      if (a.centeredSlides) {
        ...
        for (let e = n + 1; e < s.length; e += 1)
          s[e] &&
            !t &&
            ((a += Math.ceil(s[e].swiperSlideSize)), (o += 1), a > l) &&
            (t = !0);
        for (let e = n - 1; 0 <= e; --e)
          s[e] &&
            !t &&
    ...
    update() {
      ...
      if (s && !s.destroyed) {
        ...
        if (
          ...
          (i(), t.autoHeight && s.updateAutoHeight());
        else {
          if (
            ("auto" === t.slidesPerView || 1 < t.slidesPerView) &&
            s.isEnd &&
    ...
    mount(s) {
      ...
      if (!i.mounted) {
        ...
        (!a &&
          ...
          ((a = z("div", i.params.wrapperClass)),
          e.append(a),
          O(e, "." + i.params.slideClass).forEach((e) => {
            a.append(e);
          })),
          Object.assign(i, {
            el: e,
            wrapperEl: a,
            slidesEl:
              i.isElement && !e.parentNode.host.slideSlots
                ? e.parentNode.host
                : a,
            hostEl: i.isElement ? e.parentNode.host : e,
            mounted: !0,
            rtl: "rtl" === e.dir.toLowerCase() || "rtl" === C(e, "direction"),
            rtlTranslate:
              "horizontal" === i.params.direction &&
              ("rtl" === e.dir.toLowerCase() || "rtl" === C(e, "direction")),
            wrongRTL: "-webkit-box" === C(a, "display"),
          }));
      }
      return !0;
    }
    ...
    destroy(e, t) {
      ...
      if (void 0 !== a.params && !a.destroyed) {
        if (
          ...
          a.el && "string" != typeof a.el && (a.el.swiper = null);
          {
            let t = a;
            Object.keys(t).forEach((e) => {
              try {
    ...
    return (
      a.params.createElements &&
        Object.keys(r).forEach((t) => {
          if (!i[t] && !0 === i.auto) {
            let e = O(a.el, "." + r[t])[0];
            (e || (((e = z("div", r[t])).className = r[t]), a.el.append(e)),
              (i[t] = e),
              (s[t] = e));
          }
        }),
  ...
  function S(e, t, a) {
    ...
    return (s || ((s = z("div", a.split(" "))), e.append(s)), s);
  }
  return (
    ...
    m.use([
      ...
      function (e) {
        ...
        let { swiper: s, extendParams: t, on: i, emit: r } = e,
          l = [],
          n = A();
        (t({ observer: !1, observeParents: !1, observeSlideChildren: !1 }),
          i("init", () => {
            if (s.params.observer) {
              ...
              (a(s.hostEl, { childList: s.params.observeSlideChildren }),
    ...
    m.use([
      function (e) {
        let t,
          { swiper: M, extendParams: a, on: s, emit: C } = e;
        a({
          virtual: {
            enabled: !1,
            slides: [],
        ...
        function P(e, t) {
          var a = M.params.virtual;
          if (a.cache && M.virtual.cache[t]) return M.virtual.cache[t];
          let s;
          return (
            a.renderSlide
              ? "string" == typeof (s = a.renderSlide.call(M, e, t)) &&
                ((i.innerHTML = s), (s = i.children[0]))
              : (s = M.isElement
                  ? z("swiper-slide")
                  : z("div", M.params.slideClass)),
            s.setAttribute("data-swiper-slide-index", t),
            a.renderSlide || (s.innerHTML = e),
            a.cache && (M.virtual.cache[t] = s),
            s
          );
        }
        function l(m, h) {
          ...
          if (!(h && !w && 0 < b)) {
            ...
            let n,
              ...
              p =
                ...
                h -
                  (d = g
                    ? ((o = Math.floor(f / 2) + v + t),
                      Math.floor(f / 2) + v + e)
                    : ((o = f + (v - 1) + t), (w ? f : v) + e))),
              c = h + o,
              u =
                (w || ((p = Math.max(p, 0)), (c = Math.min(c, i.length - 1))),
                (M.slidesGrid[p] || 0) - (M.slidesGrid[0] || 0));
            if (
              (w && h >= d
                ? ((p -= d), g || (u += M.slidesGrid[0]))
                : w && h < d && ((p = -d), g) && (u += M.slidesGrid[0]),
              ...
              if (M.params.virtual.renderExternal)
                (M.params.virtual.renderExternal.call(M, {
                  ...
                  slides: (() => {
                    var t = [];
                    for (let e = p; e <= c; e += 1) t.push(i[e]);
                    return t;
                  })(),
                }),
                ...
                var b = w ? -i.length : 0,
                  S = w ? 2 * i.length : i.length;
                for (let t = b; t < S; t += 1)
                  if (t >= p && t <= c) {
                    let e = x(t);
                    void 0 === s || m
                      ? E.push(e)
                      : (t > s && E.push(e), t < a && y.push(e));
                  }
                if (
                  (E.forEach((e) => {
                    M.slidesEl.append(P(i[e], e));
                  }),
                  w)
                )
                  for (let t = y.length - 1; 0 <= t; --t) {
                    let e = y[t];
                    M.slidesEl.prepend(P(i[e], e));
                  }
                else
                  (y.sort((e, t) => t - e),
                    y.forEach((e) => {
                ...
                (O(M.slidesEl, ".swiper-slide, swiper-slide").forEach((e) => {
                  e.style[n] = u - Math.abs(M.cssOverflowAdjustment()) + "px";
                }),
                  T());
              }
            else
        ...
        (s("beforeInit", () => {
          if (M.params.virtual.enabled) {
            ...
            (void 0 === M.passedParams.virtual.slides &&
              ...
              l(!(M.originalParams.watchSlidesProgress = !0), !0));
          }
        }),
          s("setTranslate", () => {
          ...
          s("init update resize", () => {
            M.params.virtual.enabled &&
              M.params.cssMode &&
              L(M.wrapperEl, "--swiper-virtual-size", M.virtualSize + "px");
          }),
          Object.assign(M.virtual, {
                ...
                if (Array.isArray(a))
                  for (let e = a.length - 1; 0 <= e; --e)
                    (M.params.virtual.cache &&
                      ...
                      M.virtual.slides.splice(a[e], 1),
                      a[e] < t && --t,
                      (t = Math.max(t, 0)));
                else
                  (M.params.virtual.cache &&
                    (delete M.virtual.cache[a],
                    Object.keys(M.virtual.cache).forEach((e) => {
                      a < e &&
                        ((M.virtual.cache[e - 1] = M.virtual.cache[e]),
                        M.virtual.cache[e - 1].setAttribute(
      ...
      function (e) {
        ...
        function s(p) {
          if (c.enabled) {
            let o = c.rtlTranslate,
              e = p,
              t =
                (e = e.originalEvent ? e.originalEvent : e).keyCode ||
                e.charCode,
              a = c.params.keyboard.pageUpDown,
              s = a && 33 === t,
              i = a && 34 === t,
              r = 37 === t,
              l = 39 === t,
            ...
            if (
              !c.allowSlideNext &&
              ((c.isHorizontal() && l) || (c.isVertical() && d) || i)
            )
              return !1;
            if (
              !c.allowSlidePrev &&
              ((c.isHorizontal() && r) || (c.isVertical() && n) || s)
            )
              return !1;
            if (
              !(
              ...
              if (
                ...
                let a = !1;
                if (
                  0 < H(c.el, `.${c.params.slideClass}, swiper-slide`).length &&
                  0 === H(c.el, "." + c.params.slideActiveClass).length
                )
                  return;
                let e = c.el,
                  t = e.clientWidth,
              ...
              (c.isHorizontal()
                ? ((s || i || r || l) &&
                    (e.preventDefault
                      ? e.preventDefault()
                      : (e.returnValue = !1)),
                  (((i || l) && !o) || ((s || r) && o)) && c.slideNext(),
                  (((s || r) && !o) || ((i || l) && o)) && c.slidePrev())
                : ((s || i || n || d) &&
                    (e.preventDefault
                      ? e.preventDefault()
                      : (e.returnValue = !1)),
        ...
        function i() {
          c.keyboard.enabled ||
            (m.addEventListener("keydown", s), (c.keyboard.enabled = !0));
        }
        function r() {
          c.keyboard.enabled &&
            (m.removeEventListener("keydown", s), (c.keyboard.enabled = !1));
        }
      ...
      function (e) {
        ...
        function f(e) {
          (p.params.mousewheel.thresholdDelta &&
            ...
            (p.params.mousewheel.thresholdTime &&
              g() - i < p.params.mousewheel.thresholdTime) ||
            (6 <= e.delta && g() - i < 60) ||
            (e.direction < 0
              ? (p.isEnd && !p.params.loop) ||
                p.animating ||
                (p.slideNext(), c("scroll", e.raw))
              : (p.isBeginning && !p.params.loop) ||
                p.animating ||
                (p.slidePrev(), c("scroll", e.raw)),
        ...
        function n(s) {
          ...
          if (
            p.enabled &&
            !s.target.closest("." + p.params.mousewheel.noMousewheelClass)
          ) {
            var n = p.params.mousewheel;
            p.params.cssMode && l.preventDefault();
            let e = p.el,
              t =
                (e =
                  "container" !== p.params.mousewheel.eventsTarget
                    ? document.querySelector(p.params.mousewheel.eventsTarget)
                    : e) && e.contains(l.target);
            if (!p.mouseEntered && !t && !n.releaseOnEdges) return !0;
            l.originalEvent && (l = l.originalEvent);
            let r = 0;
            var o = p.rtlTranslate ? -1 : 1,
              d = ((e) => {
                let t = 0,
                  a = 0,
                  s = 0,
            ...
            if (
              ((a = a >= p.minTranslate() ? p.minTranslate() : a) <=
                p.maxTranslate() && (a = p.maxTranslate()),
              (i =
                !!p.params.loop ||
              ...
              if (!i) {
                m = void 0;
                let e = p.getTranslate() + r * n.sensitivity,
                  t = p.isBeginning,
                  a = p.isEnd;
                if (
                  ((e = e >= p.minTranslate() ? p.minTranslate() : e) <=
                    p.maxTranslate() && (e = p.maxTranslate()),
                  p.setTransition(0),
                  p.setTranslate(e),
                  p.updateProgress(),
                  p.updateActiveIndex(),
                  p.updateSlidesClasses(),
                  ((!t && p.isBeginning) || (!a && p.isEnd)) &&
                    p.updateSlidesClasses(),
                  p.params.loop &&
                    p.loopFix({
                  ...
                  if (
                    ...
                    ((m = s),
                      ...
                      (u = M(() => {
                        !p.destroyed &&
                          p.params &&
                          p.slideToClosest(p.params.speed, !0, void 0, e);
                      }, 0)));
                  }
                  u =
                    u ||
        ...
        function d() {
          return p.params.cssMode
            ...
            : !p.mousewheel.enabled &&
                (o("addEventListener"), (p.mousewheel.enabled = !0));
        }
        function v() {
          return p.params.cssMode
            ? (p.wrapperEl.addEventListener(event, n), !0)
            : !!p.mousewheel.enabled &&
                (o("removeEventListener"), !(p.mousewheel.enabled = !1));
        }
        (a("init", () => {
          (!p.params.mousewheel.enabled && p.params.cssMode && v(),
      ...
      function (e) {
        ...
        function p() {
          ...
          if (
            ...
            var e = i(a.nextEl),
              s = i(a.prevEl);
            (Object.assign(l.navigation, { nextEl: e, prevEl: s }),
              (e = N(e)),
              (s = N(s)));
            let t = (e, t) => {
        ...
        function c() {
          ...
          let a = (e, t) => {
            (e.removeEventListener("click", "next" === t ? d : o),
              e.classList.remove(
                ...l.params.navigation.disabledClass.split(" "),
              ));
          };
          ...
          a("enable disable", () => {
            ...
            l.enabled
              ...
              : [...e, ...t]
                  .filter((e) => !!e)
                  .forEach((e) =>
                    e.classList.add(l.params.navigation.lockClass),
                  );
          }),
          a("click", (e, t) => {
            let { nextEl: a, prevEl: s } = l.navigation;
            ((a = N(a)), (s = N(s)));
            var i = t.target;
            let r = s.includes(i) || a.includes(i);
            if (l.isElement && !r) {
              let e = t.path || (t.composedPath && t.composedPath());
              e && (r = e.find((e) => a.includes(e) || s.includes(e)));
            }
            if (
              ...
              (!(
                ...
                (l.pagination.el !== i && !l.pagination.el.contains(i)))
            ) {
              let e;
              (a.length
      ...
      function (e) {
        ...
        function s(e) {
          var t = e.target.closest(Y(d.params.pagination.bulletClass));
          if (t) {
            e.preventDefault();
            var a,
              s,
              i,
              t = G(t) * d.params.slidesPerGroup;
            if (d.params.loop) {
              if (d.realIndex !== t) {
                ((a = d.realIndex), (s = t));
                let e =
                  (s %= i = d.slides.length) == 1 + (a %= i)
                    ? "next"
                    : s == a - 1
                      ? "previous"
                      : void 0;
            ...
            let l,
              ...
              a =
                ...
                (d.virtual && d.params.virtual.enabled ? d.virtual : d).slides
                  .length),
              r = d.params.loop
                ? Math.ceil(a / d.params.slidesPerGroup)
                : d.snapGrid.length;
            if (
              (d.params.loop
                ? ((e = d.previousRealIndex || 0),
                  (l =
                    1 < d.params.slidesPerGroup
                      ...
                      : d.realIndex))
                : void 0 !== d.snapIndex
                  ? ((l = d.snapIndex), (e = d.previousSnapIndex))
                  : ((e = d.previousIndex || 0), (l = d.activeIndex || 0)),
              "bullets" === o.type &&
              ...
              if (
                (o.dynamicBullets &&
                  ((c = B(s[0], d.isHorizontal() ? "width" : "height", !0)),
                  t.forEach((e) => {
                  ...
                  1 < o.dynamicMainBullets &&
                    void 0 !== e &&
                    ((u += l - (e || 0)) > o.dynamicMainBullets - 1
                      ? (u = o.dynamicMainBullets - 1)
                      : u < 0 && (u = 0)),
                  (a = Math.max(l - u, 0)),
                  (i = a + (Math.min(s.length, o.dynamicMainBullets) - 1)),
                  (r = (i + a) / 2)),
                s.forEach((e) => {
                  var t = [
                    ...[
                ...
                let e = s[l];
                if (
                  (e && e.classList.add(...o.bulletActiveClass.split(" ")),
                  d.isElement &&
                    s.forEach((e, t) => {
                      e.setAttribute(
                        "part",
              ...
              if (o.dynamicBullets) {
                let e = Math.min(s.length, o.dynamicMainBullets + 4),
                  t = (c * e - c) / 2 - r * c,
                  a = n ? "right" : "left";
                s.forEach((e) => {
                  e.style[d.isHorizontal() ? a : "top"] = t + "px";
                });
              }
            }
            t.forEach((s, e) => {
              if (
                ("fraction" === o.type &&
                  (s.querySelectorAll(Y(o.currentClass)).forEach((e) => {
                    e.textContent = o.formatFractionCurrent(l + 1);
                  }),
                  s.querySelectorAll(Y(o.totalClass)).forEach((e) => {
                    e.textContent = o.formatFractionTotal(r);
                  })),
                "progressbar" === o.type)
              ) {
                var i = o.progressbarOpposite
                  ? d.isHorizontal()
                    ? "vertical"
                    : "horizontal"
                  : d.isHorizontal()
                ...
                let e = (l + 1) / r,
                  t = 1,
                  a = 1;
                ("horizontal" == i ? (t = e) : (a = e),
                  s.querySelectorAll(Y(o.progressbarFillClass)).forEach((e) => {
              ...
              ("custom" === o.type && o.renderCustom
                ? ((s.innerHTML = o.renderCustom(d, l + 1, r)),
                  0 === e && p("paginationRender", s))
                : (0 === e && p("paginationRender", s),
                  p("paginationUpdate", s)),
                d.params.watchOverflow &&
                  d.enabled &&
                  s.classList[d.isLocked ? "add" : "remove"](o.lockClass));
            });
          }
        }
        function l() {
            ...
            if ("bullets" === s.type) {
              ...
              for (let e = 0; e < t; e += 1)
                s.renderBullet
                  ...
                  : (a += `<${s.bulletElement} ${d.isElement ? 'part="bullet"' : ""} class="${s.bulletClass}"></${s.bulletElement}>`);
            }
            ("fraction" === s.type &&
              (a = s.renderFraction
                ...
                ("custom" !== s.type && (e.innerHTML = a || ""),
                  "bullets" === s.type &&
                    d.pagination.bullets.push(
                      ...e.querySelectorAll(Y(s.bulletClass)),
                    ));
              }),
              "custom" !== s.type && p("paginationRender", t[0]));
          }
        }
        function n() {
          d.params.pagination = X(
            d,
          ...
          if (t.el) {
            ...
            (e =
              ...
              (d.params.uniqueNavElements &&
                ...
                (e = e.filter((e) => H(e, ".swiper")[0] === d.el)[0]),
        ...
        (a("changeDirection", () => {
          ...
          a("init", () => {
            (!1 === d.params.pagination.enabled ? h : (n(), l(), r))();
          }),
          a("activeIndexChange", () => {
          ...
          a("click", (e, t) => {
            ...
            if (
              ...
              let e = a[0].classList.contains(d.params.pagination.hiddenClass);
      ...
      function (e) {
        ...
        function i() {
          if (o.params.scrollbar.el && o.scrollbar.el) {
            let { scrollbar: e, rtlTranslate: t } = o,
              { dragEl: a, el: s } = e,
            ...
            (t
              ...
              : n < 0
                ...
                : n + d > p && (l = p - n),
              o.isHorizontal()
                ? ((a.style.transform = `translate3d(${n}px, 0, 0)`),
                  (a.style.width = l + "px"))
                : ((a.style.transform = `translate3d(0px, ${n}px, 0)`),
                  (a.style.height = l + "px")),
              i.hide &&
                (clearTimeout(u),
                (s.style.opacity = 1),
        ...
        function E() {
          ...
          if (i.el) {
            ...
            if (
              (e =
                "string" == typeof i.el && o.isElement
                  ? o.el.querySelector(i.el)
                  : e) ||
              "string" != typeof i.el
            )
              e = e || i.el;
            ...
            ((e =
              ...
              e &&
                ((t = e.querySelector(Y(o.params.scrollbar.dragClass))) ||
                  ((t = z("div", o.params.scrollbar.dragClass)), e.append(t))),
              Object.assign(a, { el: e, dragEl: t }),
              i.draggable && o.params.scrollbar.el && o.scrollbar.el && y("on"),
              e &&
                e.classList[o.enabled ? "remove" : "add"](
                  ...T(o.params.scrollbar.lockClass),
                ));
          }
        }
        function x() {
          ...
          (t &&
            t.classList.remove(
              ...T(o.isHorizontal() ? e.horizontalClass : e.verticalClass),
            ),
            o.params.scrollbar.el && o.scrollbar.el && y("off"));
        }
        (t({
          scrollbar: {
            el: null,
          ...
          a("init", () => {
            (!1 === o.params.scrollbar.enabled ? S : (E(), h(), i))();
          }),
          ...
          (o.el.classList.add(...T(o.params.scrollbar.scrollbarDisabledClass)),
            o.scrollbar.el &&
              o.scrollbar.el.classList.add(
                ...T(o.params.scrollbar.scrollbarDisabledClass),
              ),
            x());
        };
        ...
        let { swiper: p, extendParams: t, on: a } = e,
          ...
          l = (t, a) => {
            ...
            var l = t.getAttribute("data-swiper-parallax-scale"),
              n = t.getAttribute("data-swiper-parallax-opacity"),
              o = t.getAttribute("data-swiper-parallax-rotate");
            if (
              (i || r
                ? ((i = i || "0"), (r = r || "0"))
                : p.isHorizontal()
              ...
              (i =
                0 <= i.indexOf("%")
                  ...
                  : i * a * e + "px"),
              (r =
                0 <= r.indexOf("%") ? parseInt(r, 10) * a + "%" : r * a + "px"),
              null != n)
            ) {
              let e = n - (n - 1) * (1 - Math.abs(a));
              t.style.opacity = e;
            }
            let d = `translate3d(${i}, ${r}, 0px)`;
            (null != l && (d += ` scale(${l - (l - 1) * (1 - Math.abs(a))})`),
              o && null != o && (d += ` rotate(${o * a * -1}deg)`),
              (t.style.transform = d));
          },
          s = () => {
            let { el: e, slides: t, progress: s, snapGrid: i } = p,
              a = O(e, r);
            (p.isElement && a.push(...O(p.hostEl, r)),
              a.forEach((e) => {
                l(e, s);
              }),
              t.forEach((e, t) => {
        ...
        (a("beforeInit", () => {
          ...
          a("setTransition", (e, t) => {
            ...
            p.params.parallax.enabled &&
              ...
              p.isElement && t.push(...s.querySelectorAll(r)),
              t.forEach((e) => {
                let t =
                  parseInt(
      ...
      function (e) {
        let { swiper: x, extendParams: t, on: a, emit: s } = e,
          S = A();
        (t({
          zoom: {
            enabled: !1,
        ...
        function m(t) {
          if (("mouse" === t.pointerType && n.splice(0, n.length), u(t))) {
            var a = x.params.zoom;
            if (((i = !1), (r = !1), n.push(t), !(n.length < 2))) {
              if (((i = !0), (M.scaleStart = c()), !M.slideEl)) {
                ...
                if (
                  ...
                  (M.imageEl = e),
                  (M.imageWrapEl = e
                    ? H(M.imageEl, "." + a.containerClass)[0]
                    : void 0),
                  !M.imageWrapEl)
                )
              ...
              if (M.imageEl) {
                let [e, t] =
                  n.length < 2
                    ? { x: null, y: null }
                    : ((a = M.imageEl.getBoundingClientRect()),
                      [
                        (n[0].pageX +
        ...
        function h(t) {
          ...
          u(t) &&
            ((e = x.params.zoom),
            (a = x.zoom),
            0 <= (s = n.findIndex((e) => e.pointerId === t.pointerId)) &&
              (n[s] = t),
            n.length < 2 ||
              ((r = !0),
              (M.scaleMove = c()),
              M.imageEl &&
                ((a.scale = (M.scaleMove / M.scaleStart) * T),
                a.scale > M.maxRatio &&
                  (a.scale =
                    M.maxRatio - 1 + (a.scale - M.maxRatio + 1) ** 0.5),
                a.scale < e.minRatio &&
                  (a.scale =
                    e.minRatio + 1 - (e.minRatio - a.scale + 1) ** 0.5),
        ...
        function f(t) {
          ...
          !u(t) ||
            ...
            i &&
              r &&
              ((i = !1), (r = !1), M.imageEl) &&
              ((a.scale = Math.max(Math.min(a.scale, M.maxRatio), e.minRatio)),
        ...
        function g(e) {
          if (
            u(e) &&
            ((t = e),
            (a = "." + x.params.zoom.containerClass),
            t.target.matches(a) ||
              0 <
                [...x.hostEl.querySelectorAll(a)].filter((e) =>
                  e.contains(t.target),
                ).length)
          ) {
            var t,
            ...
            if (M.imageEl && C.isTouched && M.slideEl) {
              C.isMoved ||
                ...
                (C.startX = k(M.imageWrapEl, "x") || 0),
                (C.startY = k(M.imageWrapEl, "y") || 0),
                (M.slideWidth = M.slideEl.offsetWidth),
                (M.slideHeight = M.slideEl.offsetHeight),
                (M.imageWrapEl.style.transitionDuration = "0ms"));
              var s = C.width * a.scale,
                i = C.height * a.scale;
              if (
                ((C.minX = Math.min(M.slideWidth / 2 - s / 2, 0)),
                (C.maxX = -C.minX),
                (C.minY = Math.min(M.slideHeight / 2 - i / 2, 0)),
                (C.maxY = -C.minY),
                (C.touchesCurrent.x = (0 < n.length ? n[0] : e).pageX),
                (C.touchesCurrent.y = (0 < n.length ? n[0] : e).pageY),
                5 <
                  Math.max(
              ...
              (e.cancelable && e.preventDefault(),
                ...
                (C.isMoved = !0));
              var s = (a.scale - T) / (M.maxRatio - x.params.zoom.minRatio),
                { originX: i, originY: e } = M;
              ((C.currentX =
                C.touchesCurrent.x -
                C.touchesStart.x +
                C.startX +
                ...
                (C.currentY =
                  ...
                  s * (C.height - 2 * e)),
                C.currentX < C.minX &&
                  (C.currentX = C.minX + 1 - (C.minX - C.currentX + 1) ** 0.8),
                C.currentX > C.maxX &&
                  (C.currentX = C.maxX - 1 + (C.currentX - C.maxX + 1) ** 0.8),
                C.currentY < C.minY &&
                  (C.currentY = C.minY + 1 - (C.minY - C.currentY + 1) ** 0.8),
                C.currentY > C.maxY &&
                  (C.currentY = C.maxY - 1 + (C.currentY - C.maxY + 1) ** 0.8),
                ...
                (o.x =
                  (C.touchesCurrent.x - o.prevPositionX) /
                  (Date.now() - o.prevTime) /
                  2),
                (o.y =
                  (C.touchesCurrent.y - o.prevPositionY) /
                  (Date.now() - o.prevTime) /
                  2),
        ...
        function b(w) {
          ...
          if (!M.slideEl) {
            ...
            ((e =
              ...
              (M.imageEl = e),
              (M.imageWrapEl = e
                ? H(M.imageEl, "." + y.containerClass)[0]
                : void 0));
          }
          if (M.imageEl && M.imageWrapEl) {
            let e, t, a, s, i, r, l, n, o, d, p, c, u, m, h, f, v, g;
            (x.params.cssMode &&
            ...
            ((b.scale = y || E),
              ...
              !w || (1 === T && y)
                ? ((l = 0), (n = 0))
                : ((v = M.slideEl.offsetWidth),
                  (g = M.slideEl.offsetHeight),
                  (a = D(M.slideEl).left + S.scrollX),
                  (s = D(M.slideEl).top + S.scrollY),
                  (i = a + v / 2 - e),
                  (r = s + g / 2 - t),
                  (o = M.imageEl.offsetWidth || M.imageEl.clientWidth),
                  (d = M.imageEl.offsetHeight || M.imageEl.clientHeight),
                  (p = o * b.scale),
                  (c = d * b.scale),
                  (h = -(u = Math.min(v / 2 - p / 2, 0))),
                  (f = -(m = Math.min(g / 2 - c / 2, 0))),
                  (l = i * b.scale),
                  (n = r * b.scale),
                  (l = l < u ? u : l) > h && (l = h),
                  (n = n < m ? m : n) > f && (n = f)),
              y && 1 === b.scale && ((M.originX = 0), (M.originY = 0)),
              (M.imageWrapEl.style.transitionDuration = "300ms"),
              (M.imageWrapEl.style.transform = `translate3d(${l}px, ${n}px,0)`),
              (M.imageEl.style.transitionDuration = "300ms"),
              (M.imageEl.style.transform = `translate3d(0,0,0) scale(${b.scale})`));
          }
        }
        function y() {
          var e = x.zoom,
          ...
          if (!M.slideEl) {
            x.params.virtual && x.params.virtual.enabled && x.virtual
              ? (M.slideEl = O(x.slidesEl, "." + x.params.slideActiveClass)[0])
              : (M.slideEl = x.slides[x.activeIndex]);
            ...
            ((e =
              ...
              (M.imageEl = e),
              (M.imageWrapEl = e
                ? H(M.imageEl, "." + t.containerClass)[0]
                : void 0));
          }
          M.imageEl &&
            M.imageWrapEl &&
        ...
        function I() {
          ...
          if (!a.enabled) {
            a.enabled = !0;
            let { passiveListener: t, activeListenerWithCapture: e } = L();
            (x.wrapperEl.addEventListener("pointerdown", m, t),
              x.wrapperEl.addEventListener("pointermove", h, e),
              ["pointerup", "pointercancel", "pointerout"].forEach((e) => {
                x.wrapperEl.addEventListener(e, f, t);
              }),
              x.wrapperEl.addEventListener("pointermove", g, e));
          }
        }
        function z() {
          var a = x.zoom;
          if (a.enabled) {
            a.enabled = !1;
            let { passiveListener: t, activeListenerWithCapture: e } = L();
            (x.wrapperEl.removeEventListener("pointerdown", m, t),
              x.wrapperEl.removeEventListener("pointermove", h, e),
              ["pointerup", "pointercancel", "pointerout"].forEach((e) => {
                x.wrapperEl.removeEventListener(e, f, t);
              }),
              x.wrapperEl.removeEventListener("pointermove", g, e));
          }
        }
        (Object.defineProperty(x.zoom, "scale", {
          ...
          set(e) {
            var t, a;
            (p !== e &&
              ((t = M.imageEl), (a = M.slideEl), s("zoomChange", e, t, a)),
              (p = e));
          },
        }),
          a("init", () => {
            x.params.zoom.enabled && I();
          }),
          a("destroy", () => {
            z();
          }),
          a("touchStart", (e, t) => {
            var a;
            x.zoom.enabled &&
              ((t = t), (a = x.device), M.imageEl) &&
              !C.isTouched &&
              (a.android && t.cancelable && t.preventDefault(),
              (C.isTouched = !0),
              (a = 0 < n.length ? n[0] : t),
              (C.touchesStart.x = a.pageX),
              (C.touchesStart.y = a.pageY));
          }),
          a("touchEnd", (e, t) => {
            if (x.zoom.enabled) {
              var a = x.zoom;
              if (M.imageEl) {
                ...
                var s = o.x * e,
                  ...
                  i = C.currentY + i,
                  r =
                    (0 !== o.x && (e = Math.abs((s - C.currentX) / o.x)),
                    0 !== o.y && (t = Math.abs((i - C.currentY) / o.y)),
                    Math.max(e, t)),
                  s = ((C.currentX = s), (C.currentY = i), C.width * a.scale),
                  i = C.height * a.scale;
                ((C.minX = Math.min(M.slideWidth / 2 - s / 2, 0)),
                  (C.maxX = -C.minX),
                  (C.minY = Math.min(M.slideHeight / 2 - i / 2, 0)),
          ...
          a("transitionEnd", () => {
            x.zoom.enabled && x.params.zoom.enabled && w();
          }),
          a("slideChange", () => {
            x.zoom.enabled && x.params.zoom.enabled && x.params.cssMode && w();
          }),
      ...
      function (e) {
        ...
        function v(e) {
          if (13 === e.keyCode || 32 === e.keyCode) {
            ...
            if (
              ...
              e.target.matches(Y(n.params.pagination.bulletClass))
            ) {
              if (n.navigation && n.navigation.prevEl && n.navigation.nextEl) {
                let e = N(n.navigation.prevEl);
                (N(n.navigation.nextEl).includes(a) &&
              ...
              n.pagination &&
                a.matches(Y(n.params.pagination.bulletClass)) &&
                a.click();
            }
          }
        }
        ...
        function w() {
          return g() && n.params.pagination.clickable;
        }
        let b = (e, t, a) => {
            var s;
            (d(e),
              "BUTTON" !== e.tagName &&
                (c(e, "button"), e.addEventListener("keydown", v)),
              m(e, a),
              (s = t),
              N(e).forEach((e) => {
          ...
          y = (e) => {
            (r && r !== e.target && !r.contains(e.target) && (i = !0),
              (n.a11y.clicked = !0));
          },
          E = () => {
            ((i = !1),
                ...
                a ||
                  ...
                  requestAnimationFrame(() => {
                    i ||
                      (n.params.loop
                        ? n.slideToLoop(
                            parseInt(e.getAttribute("data-swiper-slide-index")),
                            0,
                          )
        ...
        (a("beforeInit", () => {
          ((o = z("span", n.params.a11y.notificationClass)).setAttribute(
            "aria-live",
            "assertive",
          ),
            ...
            n.params.a11y.enabled &&
              (() => {
                ...
                var i,
                  ...
                  e = N(e),
                  l = N(l);
                (e && e.forEach((e) => b(e, s, t.nextSlideMessage)),
                  l && l.forEach((e) => b(e, s, t.prevSlideMessage)),
                  w() &&
                    N(n.pagination.el).forEach((e) => {
                      e.addEventListener("keydown", v);
                    }),
                  I().addEventListener("visibilitychange", x),
                  n.el.addEventListener("focus", S, !0),
                  n.el.addEventListener("focus", S, !0),
                  n.el.addEventListener("pointerdown", y, !0),
                  n.el.addEventListener("pointerup", E, !0));
              })();
          }),
          a(
          ...
          a("fromEdge toEdge afterInit lock unlock", () => {
            ...
            n.params.a11y.enabled &&
              ...
              t && (n.isBeginning ? (h(t), p) : (f(t), d))(t),
              e) &&
              (n.isEnd ? (h(e), p) : (f(e), d))(e);
          }),
          a("paginationUpdate", () => {
              ...
              g() &&
                n.pagination.bullets.forEach((e) => {
                  (n.params.pagination.clickable &&
                    ...
                    e.matches(Y(n.params.pagination.bulletActiveClass))
          ...
          a("destroy", () => {
            ...
            n.params.a11y.enabled &&
              ...
              t && t.forEach((e) => e.removeEventListener("keydown", v)),
              w() &&
                N(n.pagination.el).forEach((e) => {
                  e.removeEventListener("keydown", v);
                }),
              I().removeEventListener("visibilitychange", x),
              n.el) &&
              "string" != typeof n.el &&
              (n.el.removeEventListener("focus", S, !0),
              n.el.removeEventListener("pointerdown", y, !0),
              n.el.removeEventListener("pointerup", E, !0));
          }));
      },
      function (e) {
            ...
            if (r && l.params.history.enabled) {
              ...
              if (0 < l.params.history.root.length) {
                ...
                ("/" === e[e.length - 1] && (e = e.slice(0, e.length - 1)),
                  (t = e + "/" + (a ? a + "/" : "") + t));
              } else i.pathname.includes(a) || (t = (a ? a + "/" : "") + t);
      ...
      function (e) {
        let { swiper: a, extendParams: t, emit: s, on: i } = e,
          ...
          o =
            ...
            () => {
              s("hashChange");
              let t = l.location.hash.replace("#", ""),
                e =
                  a.virtual && a.params.virtual.enabled
                    ? a.slidesEl.querySelector(
                        `[data-swiper-slide-index="${a.activeIndex}"]`,
                      )
                    : a.slides[a.activeIndex];
              if (t !== (e ? e.getAttribute("data-hash") : "")) {
                let e = a.params.hashNavigation.getSlideIndex(a, t);
                void 0 === e || Number.isNaN(e) || a.slideTo(e);
              }
            }),
          d = () => {
            var e;
      ...
      function (e) {
        let r,
          l,
          { swiper: n, extendParams: t, on: a, emit: o, params: s } = e;
        ...
        function b(e) {
          n &&
            ...
            (n.wrapperEl.removeEventListener("transitionend", b),
            f || (e.detail && e.detail.bySwiperTouchMove) || M());
        }
        let y = () => {
            var e;
            !n.destroyed &&
              n.autoplay.running &&
              (n.autoplay.paused ? (i = !0) : i && ((g = d), (i = !1)),
              (e = n.autoplay.paused ? d : w + g - new Date().getTime()),
              ...
              (e = () => {
                (o("autoplayPause"),
                  n.params.autoplay.waitForTransition
                    ? n.wrapperEl.addEventListener("transitionend", b)
                    : M());
              }),
              (n.autoplay.paused = !0),
              t
                ? (m && (d = n.params.autoplay.delay), (m = !1), e())
                : ((t = d || n.params.autoplay.delay),
                  (d = t - (new Date().getTime() - w)),
                  (n.isEnd && d < 0 && !n.params.loop) ||
                    (d < 0 && (d = 0), e())));
          },
          M = () => {
            (n.isEnd && d < 0 && !n.params.loop) ||
          ...
          C = () => {
            ...
            !n.destroyed &&
              n.autoplay.running &&
              ("hidden" === (e = I()).visibilityState && ((h = !0), T(!0)),
        ...
        (a("init", () => {
          n.params.autoplay.enabled &&
            (n.params.autoplay.pauseOnMouseEnter &&
              ...
              n.el.addEventListener("pointerleave", L)),
          ...
          a("destroy", () => {
            (n.el &&
              ...
              n.el.removeEventListener("pointerleave", L)),
      ...
      function (e) {
        ...
        function r() {
          ...
          !a ||
            ...
            ((e = a.clickedIndex),
            (t = a.clickedSlide) &&
              t.classList.contains(o.params.thumbs.slideThumbActiveClass)) ||
            (null != e &&
              ((t = a.params.loop
                ? parseInt(
                    a.clickedSlide.getAttribute("data-swiper-slide-index"),
          ...
          return (
            e.swiper instanceof t
              ...
              : d(e.swiper) &&
                ...
                (i = !0)),
            o.thumbs.swiper.el.classList.add(
        ...
        function n(s) {
          ...
          if (i && !i.destroyed) {
            ...
            let t = 1,
              a = o.params.thumbs.slideThumbActiveClass;
            if (
            ...
            if (o.realIndex !== i.realIndex || n) {
              let e = i.activeIndex,
                ...
                a;
              if (i.params.loop) {
                let e = i.slides.filter(
                  (e) =>
                    e.getAttribute("data-swiper-slide-index") ===
                    "" + o.realIndex,
                )[0];
                ((t = i.slides.indexOf(e)),
                  ...
                  t = () => {
                    o.destroyed ||
                      (() => {
                        let s =
                          "string" == typeof i.swiper
                            ? e.querySelector(i.swiper)
                            : i.swiper;
                        if (s && s.swiper) ((i.swiper = s.swiper), l(), n(!0));
                        else if (s) {
                  ...
                  if (t < -u.minTranslate()) u.slideTo(u.activeIndex);
                    ...
                    if (l.freeMode.momentum) {
                      if (1 < p.velocities.length) {
                        let e = p.velocities.pop(),
                          t = p.velocities.pop(),
                          a = e.position - t.position,
                          s = e.time - t.time;
                        ((u.velocity = a / s),
                          (u.velocity /= 2),
                          Math.abs(u.velocity) < l.freeMode.minimumVelocity &&
                            (u.velocity = 0),
                          (150 < s || 300 < g() - e.time) && (u.velocity = 0));
                      } else u.velocity = 0;
                      ((u.velocity *= l.freeMode.momentumVelocityRatio),
                        (p.velocities.length = 0));
                      let a = 1e3 * l.freeMode.momentumRatio,
                        e = u.velocity * a,
                        s = u.translate + e;
                      o && (s = -s);
                      let t,
                      ...
                      if (
                        ...
                        if (
                          ...
                          let e = Math.abs((o ? -s : s) - u.translate),
      ...
      function (e) {
        let c,
          ...
          m,
          s,
          { swiper: h, extendParams: t, on: a } = e,
          f =
            (t({ grid: { rows: 1, fill: "column" } }),
            () => {
              let e = h.params.spaceBetween;
              return (
                "string" == typeof e && 0 <= e.indexOf("%")
                  ? (e = (parseFloat(e.replace("%", "")) / 100) * h.size)
                  : "string" == typeof e && (e = parseFloat(e)),
                e
              );
            });
        (a("init", () => {
          s = h.params.grid && 1 < h.params.grid.rows;
        }),
          a("update", () => {
            var { params: e, el: t } = h,
          ...
          (h.grid = {
            initSlides: (e) => {
              var t = h.params.slidesPerView,
                { rows: a, fill: s } = h.params.grid,
                e = (
                  h.virtual && h.params.virtual.enabled ? h.virtual.slides : e
                ).length;
              ((m = Math.floor(e / a)),
              ...
              h.slides &&
                h.slides.forEach((e) => {
                  e.swiperSlideGridSet &&
                    ((e.style.height = ""),
                    (e.style[h.getDirectionLabel("margin-top")] = ""));
                });
            },
            updateSlide: (s, i, r) => {
              var l = h.params.slidesPerGroup,
                e = f(),
                { rows: n, fill: t } = h.params.grid,
                r = (
                  h.virtual && h.params.virtual.enabled ? h.virtual.slides : r
                ).length;
              let o, d, p;
              if ("row" === t && 1 < l) {
                let e = Math.floor(s / (l * n)),
                  t = s - n * l * e,
                  a = 0 === e ? l : Math.min(Math.ceil((r - e * n * l) / n), l);
                ((p = Math.floor(t / a)),
                  (o = (d = t - p * a + e * l) + (p * c) / n),
                  (i.style.order = o));
              } else
                "column" === t
                  ? ((d = Math.floor(s / n)),
                    ...
                    (d > m || (d === m && p === n - 1)) &&
                      (p += 1) >= n &&
                      ((p = 0), (d += 1)))
                  : ((p = Math.floor(s / u)), (d = s - p * u));
              ((i.row = p),
                (i.column = d),
                (i.style.height = `calc((100% - ${(n - 1) * e}px) / ${n})`),
                (i.style[h.getDirectionLabel("margin-top")] =
                  0 !== p ? e && e + "px" : ""),
                (i.swiperSlideGridSet = !0));
            },
            updateWrapperSize: (e, s) => {
              var { centeredSlides: t, roundLengths: i } = h.params,
                a = f(),
                r = h.params.grid.rows;
              if (
                ((h.virtualSize = (e + a) * c),
                (h.virtualSize = Math.ceil(h.virtualSize / r) - a),
                h.params.cssMode ||
                  (h.wrapperEl.style[h.getDirectionLabel("width")] =
                    h.virtualSize + a + "px"),
                t)
              ) {
                let a = [];
                for (let t = 0; t < s.length; t += 1) {
                  let e = s[t];
                  (i && (e = Math.floor(e)),
                    s[t] < h.virtualSize + s[0] && a.push(e));
                }
                (s.splice(0, s.length), s.push(...a));
              }
            },
          }));
      },
      function (e) {
        ...
        Object.assign(e, {
          appendSlide: function (t) {
            ...
            if ("object" == typeof t && "length" in t)
              for (let e = 0; e < t.length; e += 1) t[e] && i(t[e]);
            else i(t);
            (e.recalcSlides(),
              a.loop && e.loopCreate(),
          ...
          prependSlide: function (t) {
            let e = this,
              { params: a, activeIndex: s, slidesEl: i } = e,
              r = (a.loop && e.loopDestroy(), s + 1);
            var l = (e) => {
              var t;
              "string" == typeof e
                ? (((t = document.createElement("div")).innerHTML = e),
          ...
          addSlide: function (a, t) {
            var s = this,
              { params: i, activeIndex: r, slidesEl: l } = s;
            let n = r;
            if (
              (i.loop &&
          ...
          removeSlide: function (t) {
            ...
            if ("object" == typeof t && "length" in t)
              for (let e = 0; e < t.length; e += 1)
                ((r = t[e]), a.slides[r] && a.slides[r].remove(), r < l && --l);
            ...
            setTranslate: () => {
              ...
              for (let s = 0; s < e.length; s += 1) {
                let e = l.slides[s],
                  ...
                  a = (l.params.virtualTranslate || (t -= l.translate), 0);
                l.isHorizontal() || ((a = t), (t = 0));
                var i = l.params.fadeEffect.crossFade
                    ? Math.max(1 - Math.abs(e.progress), 0)
                    : 1 + Math.min(Math.max(e.progress, -1), 0),
                  r = x(0, e);
                ((r.style.opacity = i),
                  (r.style.transform = `translate3d(${t}px, ${a}px, 0px)`));
              }
            },
            setTransition: (t) => {
              var e = l.slides.map((e) => r(e));
              (e.forEach((e) => {
      ...
      function (e) {
        ...
        h({
          ...
          setTranslate: () => {
            ...
            m.shadow &&
              (h
                ? ((l = n.wrapperEl.querySelector(".swiper-cube-shadow")) ||
                    ((l = z("div", "swiper-cube-shadow")),
                    n.wrapperEl.append(l)),
                  (l.style.height = a + "px"))
                : (l = e.querySelector(".swiper-cube-shadow")) ||
                  ((l = z("div", "swiper-cube-shadow")), e.append(l)));
            for (let o = 0; o < d.length; o += 1) {
              ...
              (t % 4 == 0
                ...
                : (t - 1) % 4 == 0
                  ...
                  : (t - 2) % 4 == 0
                    ? ((r = c + 4 * s * c), (n = c))
                    : (t - 3) % 4 == 0 && ((r = -c), (n = 3 * c + 4 * c * s)),
                p && (r = -r),
                h || ((l = r), (r = 0)));
              var g = `rotateX(${u(h ? 0 : -a)}deg) rotateY(${u(h ? a : 0)}deg) translate3d(${r}px, ${l}px, ${n}px)`;
              (i <= 1 &&
                -1 < i &&
                ((v = 90 * t + 90 * i), p) &&
                (v = 90 * -t - 90 * i),
                (e.style.transform = g),
                m.slideShadows && w(e, i, h));
            }
            if (
              ((t.style.transformOrigin = `50% 50% -${c / 2}px`),
              (t.style["-webkit-transform-origin"] = `50% 50% -${c / 2}px`),
              m.shadow)
            )
              if (h)
                l.style.transform = `translate3d(0px, ${a / 2 + m.shadowOffset}px, ${-a / 2}px) rotateX(89.99deg) rotateZ(0deg) scale(${m.shadowScale})`;
              else {
                let e = Math.abs(v) - 90 * Math.floor(Math.abs(v) / 90),
                  t =
                    1.5 -
                  ...
                  s = m.shadowScale / t,
                  i = m.shadowOffset;
                l.style.transform = `scale3d(${a}, 1, ${s}) translate3d(0px, ${r / 2 + i}px, ${-r / 2 / s}px) rotateX(-89.99deg)`;
              }
            var i =
              (s.isSafari || s.isWebView) && s.needPerspectiveFix ? -c / 2 : 0;
            ((t.style.transform = `translate3d(0px,0,${i}px) rotateX(${u(n.isHorizontal() ? 0 : v)}deg) rotateY(${u(n.isHorizontal() ? -v : 0)}deg)`),
              t.style.setProperty("--swiper-cube-translate-z", i + "px"));
          },
          setTransition: (t) => {
            var { el: a, slides: e } = n;
            if (
              ...
              let e = a.querySelector(".swiper-cube-shadow");
              e && (e.style.transitionDuration = t + "ms");
            }
          },
          recreateShadows: () => {
            let a = n.isHorizontal();
            n.slides.forEach((e) => {
            ...
            (e, t) => {
              let a = u.isHorizontal()
                ...
                s = u.isHorizontal()
                  ? e.querySelector(".swiper-slide-shadow-right")
                  : e.querySelector(".swiper-slide-shadow-bottom");
              ((a = a || S("flip", e, u.isHorizontal() ? "left" : "top")),
                (s = s || S("flip", e, u.isHorizontal() ? "right" : "bottom")),
        ...
        h({
          ...
          setTranslate: () => {
            ...
            for (let r = 0; r < l.length; r += 1) {
              ...
              c = `translate3d(${s}px, ${i}px, 0px) rotateX(${d(a)}deg) rotateY(${d(t)}deg)`;
          ...
          setTransition: (t) => {
            ...
            (e.forEach((e) => {
              ...
              n({ swiper: u, duration: t, transformElements: e }));
          },
          recreateShadows: () => {
            (u.params.flipEffect,
              u.slides.forEach((e) => {
      ...
      function (e) {
        ...
        (t({
          ...
          h({
            ...
            on: a,
            setTranslate: () => {
              let { width: e, height: t, slides: u, slidesSizesGrid: m } = s,
                h = s.params.coverflowEffect,
                f = s.isHorizontal(),
                a = s.translate,
                v = f ? e / 2 - a : t / 2 - a,
                g = f ? h.rotate : -h.rotate,
                w = h.depth,
                b = E(s);
              for (let c = 0, e = u.length; c < e; c += 1) {
                let a = u[c],
                  e = m[c],
                  t = (v - a.swiperSlideOffset - e / 2) / e,
                  s =
                  ...
                  o =
                    ("string" == typeof n &&
                      -1 !== n.indexOf("%") &&
                      (n = (parseFloat(h.stretch) / 100) * e),
                    f ? 0 : n * s),
                  d = f ? n * s : 0,
                  p = 1 - (1 - h.scale) * Math.abs(s);
                ...
                var y = `translate3d(${d}px,${o}px,${l}px)  rotateX(${b(r)}deg) rotateY(${b(i)}deg) scale(${p})`;
                if (
                  ((x(0, a).style.transform = y),
                  (a.style.zIndex = 1 - Math.abs(Math.round(s))),
                  h.slideShadows)
                ) {
                  let e = f
                  ...
                  ((e = e || S("coverflow", a, f ? "left" : "top")),
                    (t = t || S("coverflow", a, f ? "right" : "bottom")),
      ...
      function (e) {
        ...
        h({
          ...
          on: a,
          setTranslate: () => {
            let { slides: p, wrapperEl: t, slidesSizesGrid: a } = b,
              c = b.params.creativeEffect,
              u = c.progressMultiplier,
              m = b.params.centeredSlides,
              h = E(b);
            if (m) {
              let e = a[0] / 2 - b.params.slidesOffsetBefore || 0;
            ...
            for (let d = 0; d < p.length; d += 1) {
              let e = p[d],
                t = e.progress,
                s = Math.min(
                  Math.max(e.progress, -c.limitProgress),
                  c.limitProgress,
                ),
                a = s,
                i =
                  (m ||
                    (a = Math.min(
                      Math.max(e.originalProgress, -c.limitProgress),
                      c.limitProgress,
                    )),
                  e.swiperSlideOffset),
                r = [b.params.cssMode ? -i - b.translate : -i, 0, 0],
                l = [0, 0, 0],
                n = !1,
                o =
                  (b.isHorizontal() || ((r[1] = r[0]), (r[0] = 0)),
                  {
                    translate: [0, 0, 0],
                    rotate: [0, 0, 0],
                    scale: 1,
              ...
              (s < 0
                ...
                r.forEach((e, t) => {
                  r[t] =
                    `calc(${e}px + (${((e = o.translate[t]), "string" == typeof e ? e : e + "px")} * ${Math.abs(s * u)}))`;
                }),
                l.forEach((e, t) => {
                  var a = o.rotate[t] * Math.abs(s * u);
                  l[t] = a;
                }),
                (e.style.zIndex = -Math.abs(Math.round(t)) + p.length));
              var f = r.join(", "),
                v = `rotateX(${h(l[0])}deg) rotateY(${h(l[1])}deg) rotateZ(${h(l[2])}deg)`,
                g =
                  a < 0
                    ? `scale(${1 + (1 - o.scale) * a * u})`
                    : `scale(${1 - (1 - o.scale) * a * u})`,
                w =
                  a < 0
                    ? 1 + (1 - o.opacity) * a * u
              ...
              if ((n && o.shadow) || !n) {
                ...
                if ((t = !t && o.shadow ? S("creative", e) : t)) {
                  let e = c.shadowPerProgress ? s * (1 / c.limitProgress) : s;
              ...
              ((v.style.transform = f),
                (v.style.opacity = w),
                o.origin && (v.style.transformOrigin = o.origin));
            }
          },
          setTransition: (t) => {
      ...
      function (e) {
        ...
        (t({
          ...
          h({
            ...
            on: a,
            setTranslate: () => {
              let { slides: n, activeIndex: o, rtlTranslate: d } = y,
              ...
              for (let l = 0; l < n.length; l += 1) {
                ...
                let s = 1,
                  ...
                  r = p.perSlideOffset - 0.75 * Math.abs(v);
                var w =
                  ...
                  w =
                    ...
                    c < m;
                if (b || w) {
                  let e = (1 - Math.abs((Math.abs(v) - 0.5) / 0.5)) ** 0.5;
                  ((i += -28 * v * e),
                    (s += -0.5 * e),
                    (r += 96 * e),
                    (a = -25 * e * Math.abs(v) + "%"));
      ...
      `));
                ...
                ((h.style.zIndex = -Math.abs(Math.round(f)) + n.length),
            ...
            setTransition: (t) => {
              ...
              (e.forEach((e) => {
                ...
                n({ swiper: y, duration: t, transformElements: e }));
            },
            perspective: () => !0,
            overwriteParams: () => ({
              watchSlidesProgress: !0,
